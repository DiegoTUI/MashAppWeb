...
(function() {
	...
	if (isTablet) {
		...
		if (osname === 'iphone') {
			Window = require('view/handheld/ios/ApplicationWindow');
		}
		else if (osname == 'mobileweb') {
			Window = require('view/handheld/mobileweb/ApplicationWindow');
		}
		else {
			Window = require('view/handheld/android/ApplicationWindow');
		}
	}
	new Window().open();
})();
